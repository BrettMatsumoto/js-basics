...
var favFood = 'Pizza';
console.log(favFood);
var favDrink = 'drPepper';
console.log(favDrink);
var favSong = 'seasonsUponUS';
console.log(favSong);
var favAnimal = 'Dog';
...
var completedPrepClass = 500;  
completedPrepClass = null;
console.log(completedPrepClass);

/*Another thing I could've done to make it simpler
var completedPrepClass = null;
console.log(completedPrepClass);
*/

var traveledToMars = true;
traveledToMars = null;
console.log(traveledToMars);

var buyVicADrink = 'Maybe';
buyVicADrink = null;
...
var plateLunch = ['chicken', 'pork', 'rice', 'macSalad', 'cabbage'];
console.log(plateLunch);
var donutBox = ['glazed', 'jamFilled', 'donutHoles', 'chocolate', 'strawberry'];
console.log(donutBox);
var westCoast = ['california', 'washington', 'navada', 'colorado', 'montana'];
console.log(westCoast);
var lotteryResult = [4, 12, 3, 9, 32];
console.log(lotteryResult);
var hamajang = ['string', 'number', 'boolean', 'null', 'undefined', 'object'];
console.log(hamajang);
var dynamicDuos = [['batman', 'robin'],['robinHood', 'littleJohn'],['wonderTwinSister', 'wonderTwinBrother']];
...
var secondary = "and I was born in";
var sentence = intro + ' ' + fullName + ' ' + secondary + ' ' + birthPlace;
console.log(sentence);
// it was after I looked at the solutions did i remember that you could build the sentence in the console.log instead of creating more variables to concatenate
...
/* With strictly equal, both the data type and capitalization matter. If it is not exact, it is not strictly equal. */
...
function makeFood(ingredient1, ingredient2, recipieName){
    return ingredient1 + ' and ' + ingredient2 + ' make a ' + recipieName + ".";
}
